...
class UserBilfenSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $role_admin = app(\Spatie\Permission\PermissionRegistrar::class)->getRoleClass()::findByName('admin');
        ...
        /// ///////////           ///////////           ///////////           ///////////           ///////////
        $student = factory(\App\Models\User::class)->make([
            'username' => 44335644772,
            'gender' => 1,
            'email' => 'admin@bilfen.com',
            'password' => \Illuminate\Support\Facades\Hash::make('gameon'),
            'name' => 'Administrator',
        ]);
        $student->save();
