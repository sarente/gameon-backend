...
class UserAssignCategory extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'user:assign:category';
        ...
        for ($page = 0; $page < $pageCount; $page++) {
            ...
            foreach ($users as $user) {
                if ($user->hasRole(Setting::ROLE_USER)) {
                    ...
                    \App\Jobs\CategoryAssignment::dispatch($user, Carbon::now())->delay(now()->addSecond(1)); // put to database
                }
            }
