...
class UserAssignWorkflow extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'user:assign:workflow';
        ...
        for ($page = 0; $page < $pageCount; $page++) {
            ...
            foreach ($users as $user) {
                if ($user->hasRole(Setting::ROLE_USER)) {
                    ...
                    \App\Jobs\WorkflowAssignment::dispatch($user, Carbon::now())->delay(now()->addSecond(1)); // put to database
                }
            }
