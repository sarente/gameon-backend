...
class ComputeXP implements ShouldQueue
{
    ...
    public function handle(ArtifactIsCompleted $event)
    {
        ...
        if($artifact_name==Setting::ARTIFACT_QUESTION){
            $artifact_name=Setting::ARTIFACT_QUESTION_ANSWER;
        }
        ...
        //Set all users general experience
        //event(new ComputeGeneral($users));
    }
}
